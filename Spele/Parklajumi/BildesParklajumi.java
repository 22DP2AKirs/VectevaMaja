	...
	private static void istabuParklajumuUzlicejs(String[] mainamaisMasivs) {
		...
		if (Main.varonaIstabasSkaitlis == 0) {
			...
			if (Main.varonaVirzienaSkaitlis == 0) {
				...
				if (!Main.istabuGaismasIeslegtas[1]) {
					for (int i = 1; i < 13; i++) {
						mainamaisMasivs[i] += "\033[45G" + K.TPELEKS + arkuGaismasAizpilditajs[0] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					}
				}
			}
			// ? Labā puse.
				...
				if (!Main.istabuGaismasIeslegtas[3]) {
					for (int i = 1; i < 13; i++) {
						mainamaisMasivs[i] += "\033[39G" + K.TPELEKS + arkuGaismasAizpilditajs[0] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					}
				}
      		}
			// ? Leja.
		...
		// * Dīvāns.
			...
			if (Main.varonaVirzienaSkaitlis == 1) {
				if (!Main.istabuGaismasIeslegtas[2]) {
					mainamaisMasivs[2] += "\033[57G" + K.TPELEKS + arkuGaismasAizpilditajs[1] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					for (int i = 3; i < 13; i++) {
						mainamaisMasivs[i] += "\033[55G" + K.TPELEKS + arkuGaismasAizpilditajs[0] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					}
				}
			}
			// ? Leja.
				...
				if (!Main.istabuGaismasIeslegtas[0]){
					for (int i = 1; i < 13; i++) {
						mainamaisMasivs[i] += "\033[23G" + K.TPELEKS + arkuGaismasAizpilditajs[0] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					}
				}
		...
		// * Durvis.
			...
			// ? Leja.
				...
				if (!Main.istabuGaismasIeslegtas[3]) {
					for (int i = 2; i < 13; i++) {
						mainamaisMasivs[i] += "\033[20G" + K.TPELEKS + arkuGaismasAizpilditajs[0] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					}
				}
			}
			// ? Kreisa puse.
				...
				// ^
				if (!Main.istabuGaismasIeslegtas[1]) {
					mainamaisMasivs[1] += "\033[24G" + K.TPELEKS + arkuGaismasAizpilditajs[1] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					for (int i = 2; i < 13; i++) {
						mainamaisMasivs[i] += "\033[22G" + K.TPELEKS + arkuGaismasAizpilditajs[0] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					}
				}
			}
		}
		...
		// * Virtuve.
			...
			if (Main.varonaVirzienaSkaitlis == 0) {
				...
				if (!Main.istabuGaismasIeslegtas[2]) {
					for (int i = 2; i < 13; i++) {
						mainamaisMasivs[i] += "\033[48G" + K.TPELEKS + arkuGaismasAizpilditajs[0] + K.RESET + K.BILDES_MASIVA_BEIGU_KURSORA_POZICIJA;
					}
				}
			}
			// ? Labā puse.
			...
			// ? Kreisā puse.
				...
				if (!Main.istabuGaismasIeslegtas[0] && Main.varonaVirzienaSkaitlis == 3) {
					for (int i = 1; i < 13; i++) {
						mainamaisMasivs[i] += "\033[26G" + arkuGaismasAizpilditajs[0];
					}
				}
			}
		}
